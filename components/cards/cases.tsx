...
export default function CardCases() {
  return (
    <article className={`relative grid grid-cols-3 gap-3  md:gap-6 py-6 md:py-0 md:my-6 border-[#a6a6a6] border-b-[0.5px] md:border-none ${styles.block_hover}`}>
      <Image
      ...
      <div className="col-span-3 sm:col-span-2 flex flex-col justify-start md:border-[#a6a6a6] md:border-b-[0.5px]">
        {" "}
        <h3 className="text-18 leading-28 md:text-22 md:leading-27 font-normal text-black mb-1 md:mb-3">
          sdaf
        </h3>
